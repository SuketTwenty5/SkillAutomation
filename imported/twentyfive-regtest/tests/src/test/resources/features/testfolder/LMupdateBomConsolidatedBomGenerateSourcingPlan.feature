@updateBomCondolidatedBomGenerateSourcingPlan
Feature: 3. Update Production/System Proposal BOM & Consolidated BOM & Generate Sourcing Plan

  @ART-201 @LM-TC-003_1 @START
  Scenario: TC-Production/System-Proposal-010: Validate UI Behavior [Proposal BOM]
    Given open TC-Production-or-System-Proposal-009 boe
