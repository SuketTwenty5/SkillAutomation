 ...
 */
@WebPage(value = "Opportunity Details page", urlTemplate = ".*#quote:new:type=PS_consulting$|.*#quote:new:type=PS_consulting_simple$|.*#quote:new:type=PS_consulting_simple$|.*#quote:new:type=CP_capproject$|.*#proposal:new:type=PS_consulting_simple$|.*#proposal:new:type=DI_service$|.*:new:.*|.*proposal:[0-9A-Fa-f]{8}(?:-[0-9A-Fa-f]{4}){3}-[0-9A-Fa-f]{12}$|.*quote:[0-9A-Fa-f]{8}(?:-[0-9A-Fa-f]{4}){3}-[0-9A-Fa-f]{12}$", tabName = "Opportunity Details")
public class OpportunityDetails extends MainPage {
    ...
    @FindBy(xpath = "//input[@placeholder='Select Company']")
    IpeDropdownField leadingCompanyField;
