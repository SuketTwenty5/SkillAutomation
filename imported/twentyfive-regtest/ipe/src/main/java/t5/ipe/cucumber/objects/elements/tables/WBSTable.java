 ...
 * Date: 14/11/2023
 */
public class WBSTable extends BaseWebElement implements EditableTable, ReadableTable, CheckableTable {
...
//            }
    ...
    private String getCheckBoxElement(String columnName, int index) {
        ...
        return "(//table//tr[contains(@class,'x-grid-row') and (@data-qtip) ])[" + index + "]" + xpath;
    }
