...
public class setsTable  extends BaseWebElement implements EditableTable, ReadableTable, CheckableTable {
    ...
    private static final String ALL_ROWS_XPATH = "//tr[contains(@class,'x-grid-row')]";
    ...
    public void setCellValue(String value, String columnName, Map<String, String> rowFilter) {
        ...
        } else if (columnName.equals("Start") | (columnName.equals("End")) | (columnName.equals("Description"))) {
    ...
    public void uncheckCell(String columnName, Map<String, String> rowFilter) {
         if (columnName.equals("Subscription")) {
...
//            }
    ...
    private String getCheckBoxElement(String columnName, Map<String, String> rowFilter) {
        ...
        switch (columnName) {
            case "Stand-alone":
            case "Option":
                xpath = "//*[@data-columnid='phasesTabOptionColumn']//*[@role='button']";
                break;
            case "Copy":
                xpath = "//*[contains(@class, 'copy')]";
                break;
            case "-":
                xpath = "//*[contains(@class, 'minus')]";
                break;
            case "Baseline":
                xpath = "//*[@data-columnid='phasesTabBaselineColumn']//*[@role='button']";
                break;
            case "Edit":
                xpath = EDIT_XPATH;
                break;
