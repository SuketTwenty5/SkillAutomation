...
public class IpeDialogViewDropdownField  extends TextElement implements Selectable {

    @Override
    public void select(String text) {
        String primaryXPath = "//*[@role='dialog' and @aria-hidden='false']//*[@role='tabpanel' and @aria-hidden='false']" +
        ...
        String fallbackXPath =
                "//*[@role='dialog' and @aria-hidden='false']//*[(@role='grid' or @role='treegrid') and @aria-hidden='false']" +
                        "//*[(@role='toolbar' or @role='group') and @aria-hidden='false']" +
                        "//a[@aria-hidden='false' and contains(@class,'x-split-button')]" +
                        "//span[@data-ref='btnWrap']";
