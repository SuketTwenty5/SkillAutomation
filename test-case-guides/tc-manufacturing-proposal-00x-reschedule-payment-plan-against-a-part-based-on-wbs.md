# TC-Manufacturing-Proposal-00X - Reschedule Payment Plan against a Part based on WBS

| Field | Value |
| --- | --- |
| Test ID | TC-Manufacturing-Proposal-00X |
| Title | Reschedule Payment Plan against a Part based on WBS |
| RTA page | https://twenty5.atlassian.net/wiki/spaces/RTA/pages/193953981/TC-Manufacturing-Proposal-00X+Reschedule+Payment+Plan+against+a+Part+based+on+WBS |
