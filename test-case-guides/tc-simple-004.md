# TC-SIMPLE-004 - Create Labor Resource Quick Path

| Field | Value |
| --- | --- |
| Test ID | TC-SIMPLE-004 |
| Title | Create Labor Resource Quick Path |
| RTA page | https://twenty5.atlassian.net/wiki/spaces/RTA/pages/200966679/TC-SIMPLE-004+Create+Labor+Resource+Quick+Path |
