# TC-BOM-Import-Excel-002 - Cost BOM Imported from File

| Field | Value |
| --- | --- |
| Test ID | TC-BOM-Import-Excel-002 |
| Title | Cost BOM Imported from File |
| RTA page | https://twenty5.atlassian.net/wiki/spaces/RTA/pages/657129473/BTP+Gold+TC-BOM-Import-Excel-002+Cost+BOM+Imported+from+File |
