# TC-SIMPLE-007 - Create Billing Plan Quick Path

| Field | Value |
| --- | --- |
| Test ID | TC-SIMPLE-007 |
| Title | Create Billing Plan Quick Path |
| RTA page | https://twenty5.atlassian.net/wiki/spaces/RTA/pages/200967030/TC-SIMPLE-007+Create+Billing+Plan+Quick+Path |
