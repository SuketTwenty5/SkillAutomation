# TC-Manufacturing-Proposal-00X - Create New Part Number

| Field | Value |
| --- | --- |
| Test ID | TC-Manufacturing-Proposal-00X |
| Title | Create New Part Number |
| RTA page | https://twenty5.atlassian.net/wiki/spaces/RTA/pages/193691649/TC-Manufacturing-Proposal-00X+Create+New+Part+Number |
