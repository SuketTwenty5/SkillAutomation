# TC-SIMPLE-005 - Create Other Resource Quick Path

| Field | Value |
| --- | --- |
| Test ID | TC-SIMPLE-005 |
| Title | Create Other Resource Quick Path |
| RTA page | https://twenty5.atlassian.net/wiki/spaces/RTA/pages/200966799/TC-SIMPLE-005+Create+Other+Resource+Quick+Path |
